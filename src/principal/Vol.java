...
public class Vol implements Component {
	...
	/*
	 * Paràmetres: cap Accions: - Demanar a l'usuari les dades per consola per crear
	 * un nou vol. Les dades a demanar són les que necessita el constructor. - En el
	 * cas de les dates, li hem de demanar a l'usuari que les introdueixi amb el
	 * format dd-mm-yyyy. Penseu que la data introduïda per l'usuari serà de tipus
	 * String i nosaltres l'hem de convertir a data. - En el cas de les hores només
	...
	/*
	 * Paràmetres: cap Accions: - Demanar a l'usuari que introdueixi les noves dades
	 ...
	 * valors de les dates i les hores, farem el mateix que en el mètode anterior
	 * nouVol(). - Si es modifiquen els atributs de data o d'hora, també s'haurà de
	 * modificar el valor de durada mitjançant el mètode adient d'aquesta classe.
	 * Retorn: cap
	 */
	...
	/*
	 * Paràmetres: cap Accions: - Se li assignarà a l'atribut durada el valor tenint
	 * en compte que la durada és la diferència de temps entre la data i hora de
