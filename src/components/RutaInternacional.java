...
public class RutaInternacional extends Ruta {
	...
	/*
	 * CONSTRUCTOR Paràmetres: valors per tots els atributs de la classe. Accions: -
	 * Assignar als atributs els valors passats com a paràmetres.
	 */
	public RutaInternacional(String codi, String aeroportOri, String aeroportDes, String paisOri, String paisDes,
			double distancia) throws GestioVolsExcepcio {
	 ...
	 * una nova ruta internacional. Les dades a demanar són les que necessita el
	 * constructor. - Heu de tenir en compte que els aeroports països no tene per
	 * què estar formats per una única paraula, per exemple, El Prat o Regne Unit.
	 */
